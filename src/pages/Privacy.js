    ...
    <div>
      <header className="header">
        ...
        <div className="landing-text">
          ...
          <p>
            <span>
              Learn more about how eelspace collects and uses data and your
              rights as an eelspace user.
            </span>
      ...
      <main>
        <div className="web-container container ">
          ...
          <div className="t-component">
            <h5 className="tos-head">
              Your Consent to use Electronic Signatures and Communications
            </h5>
            <p className="tos-body">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem
              ipsum dolor sit amet, consectetur adipiscing elit, sed do ei.
            </p>
          </div>
          <div className="t-component">
            <h5 className="tos-head">
